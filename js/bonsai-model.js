...
export const SPECIES = {
  kuromatsu: {
    ...
    name: '黒松',
    trunkColor: '#5c4632',
    trunkColorDark: '#3a2c1e',
    leafColors: ['#33513a', '#2c4732', '#3e5c42', '#26402d'],
    leafShape: 'needle',
    leafBaseSize: 5,
    leafDensityBase: 0.8,
    branchSpread: [22, 58],
    potColors: ['#4a3527', '#5b4636', '#33261c'],
  },
  kaede: {
    key: 'kaede',
    name: '楓',
    trunkColor: '#8a7862',
    trunkColorDark: '#6b5a48',
    leafColors: ['#7a9b5a', '#c3703a', '#b04a3a', '#8fae5f'],
    leafShape: 'round',
    leafBaseSize: 7,
    leafDensityBase: 0.65,
    branchSpread: [26, 65],
    potColors: ['#5b4636', '#3e3a35', '#6b4a34'],
  },
  ume: {
    key: 'ume',
    name: '梅',
    trunkColor: '#5a5048',
    trunkColorDark: '#3e372f',
    leafColors: ['#e8c6cf', '#f2e0e6', '#d99aa8', '#efd3da'],
    leafShape: 'round',
    leafBaseSize: 4,
    leafDensityBase: 0.5,
    branchSpread: [32, 72],
    potColors: ['#4a4038', '#3e3a35', '#5b4636'],
  },
};
